...
int main()
{
    ...
    std::cout << (+obj2).val_  << std::endl;
    // 输出58
    std::cout << (obj + obj2).val_ << std::endl;
    // 输出-48
    std::cout << (obj - obj2).val_ << std::endl;
    // 输出265
    std::cout << (obj * obj2).val_ << std::endl;
    ...
    std::cout << (obj / obj2).val_ << std::endl;
    // 输出3
    std::cout << (obj2 % obj).val_ << std::endl;
    return 0;
}
```
...
{
    // 输出0-10
    for (Index i; i.val_ <= 10; ++i)
        std::cout << i.val_ << std::endl;
    // 输出0-10
    for (Index i{10}; i.val_ >= 0; --i)
        std::cout << i.val_ << std::endl;
    return 0;
}
```
...
{
    // 输出0-10
    for (Index i; i.val_ <= 10; i.operator++(0)) // 显式调用
        std::cout << i.val_ << std::endl;
    // 输出10-0
    for (Index i{10}; i.val_ >= 0; i.operator--(184)) // 显式调用
        std::cout << i.val_ << std::endl;
    return 0;
}
```
